        ...
        <section className="bg-black pb-52">
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    Immerse yourself in a rich and ever-expanding universe where a vibrant array of products converge into a interconnected overlay experiencing your world.
                    </p>
                </div>
            ...
            <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
                ...
                <BentoTilt className="bento-tilt_1 border-hsla col-span-2 row-span-1 ms-32 md:col-span-1 md:ms-0">
                    <BentoCard
